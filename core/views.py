...
def index(request):
    ...
    for ids in username_profile:
        profille_lists = Profile.objects.filter(id_user = ids)
        username_profile_list.append(profille_lists)
...
def signup(request):
    if request.method == 'POST':    # this is when the user hit sign up btn and processing
        username = request.POST['username']
